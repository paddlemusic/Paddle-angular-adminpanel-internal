...
@Component({
  selector: 'app-most-liked-album',
  templateUrl: './most-liked-album.component.html',
  styleUrls: ['./most-liked-album.component.scss']
})
export class MostLikedAlbumComponent implements OnInit,OnChanges {
