...
@Component({
  selector: 'app-most-liked-artist',
  templateUrl: './most-liked-artist.component.html',
  styleUrls: ['./most-liked-artist.component.scss']
})
export class MostLikedArtistComponent implements OnInit,OnChanges {
